...
<body>
	...
	<nav class = "navbar navbar-default">
		<div class = "collapse navbar-collapse" id = "bs-example-navbar-collapse-1">
			<ul class = "nav navbar-nav">
				<li><a href = "info.jsp">일반정보</a></li>
				<li><a href = "vaccination.jsp">예방접종</a></li>
				<li><a href = "raw.jsp">관련정책</a></li>
				<li class = "active"><a href = "fna.jsp">F&A</a></li>
			</ul>
		</div>
	</nav>
	...
	<% if (userID == "admin") {%>
		<%--[F&A] 관리자 정보추가 버튼--%>
		<a href = "writeFna.jsp" class = "btn btn-primary pull-right" style = "margin : 5px 15px 10px;">정보 추가</a>
		<br><br><br>
	<% } %>
